...
def index(request):
    city = 'Osh'
    country = 'Kyrgyzstan'
    cities = ['Osh', 'Bishkek', 'Talas','Chuy','Issyk_kul','Naryn','Djalal_abat']
    number = [4, 45, -7, 11, -58, 47]
    return render(request, 'index.html', context={'my_city':city,'my_country':country,'my_citi':cities, 'numbers':number})
...
def weather(request):
    if request.method == 'POST':
        ...
        'max_temp': max_temp,'icon_id':icon_id})
        # print(city_name)
